...
xfemale = as.matrix(c(0,1,0,0,0,0,0,1), ncol = 1)
xmale =   as.matrix(c(1,0,0,0,0,0,0,1), ncol = 1)
...
## Example propensity: Fever + Not H + White + Male
xfemale = as.matrix(c(0,1,0,0,0,0,0,0), ncol = 1)
xmale =   as.matrix(c(1,0,0,0,0,0,0,0), ncol = 1)
