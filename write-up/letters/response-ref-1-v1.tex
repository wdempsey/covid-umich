...
\begin{itemize}
	...
	We now connect with this literature on biases in SEction 1.1.  We highlight
	\vspace{5mm}
	...
	Remark within validation subsection to contrast with validation sample. We state that this is a fairly novel
	\vspace{5mm}
