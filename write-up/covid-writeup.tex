...
Figure~\ref{fig:deathsppc} performs a posterior predictive check on aggregate
...
Present IPW1, IPW2, Model-based, DR1, and DR2.

We notice that IPW1/2 don't improve greatly but this may be due to the

We notice model-based rates are much lower, but
