...
Many states do not provide any demographic information on who requested a test nor on who tested positive for SARS-CoV-2. Working closely with the State of Indiana, the author's were able to request public availability of COVID-19 total tests, positive tests, and related deaths per day broken out marginally by age, gender, ethnicity, and race.  Similar demographic breakdowns may be available for other states, but to date the data has not been made publicly available at the daily level.
