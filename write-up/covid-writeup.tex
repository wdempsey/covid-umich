...
\frac{\rho_{I_1, Y_1} \times \sqrt{\frac{1-f_1}{f_1}}  - \rho_{I_2, Y_2} \times \sqrt{\frac{1-f_2}{f_2}} }{ \sqrt{\frac{1}{N_1 -1} \times \frac{1-f_1}{f_1} + \frac{1}{N_2 - 1} \times \frac{1-f_2}{f_2}} } \overset{\star}{=}
...
While problematic, this points to a potential setting in which comparisons are still valid: when sampling fraction~$f_1 = f_2$ are equal and data quality are equal.  The issue is how to assess data quality equivalence among populations. \textcolor{red}{Discuss the measures in the literature.}
