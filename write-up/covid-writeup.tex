...
Rather than relying solely on IPW or epidemiological forecasts, we combine forecasting and inverse-probability weighting by extending recent work by~\cite{Chen2019} to account time-varying propensities and measurement-error. The doubly-robust estimator is presented in Appendix~\ref{app:drestimation}.
 \end{remark}
