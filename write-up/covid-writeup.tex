...
A real-world constraint for countries, states, and municipalities is the monetary and time cost of random sampling. The second objective of this paper is to demonstrate how random samples provide necessary auxiliary information to address selection bias in coronavirus case-count data.

Using a random sample from Indiana, we construct improved  corrected estimates of the prevalence and true case-counts.  We end with several remarks on cautious use of these methods.
