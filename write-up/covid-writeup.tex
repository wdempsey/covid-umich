...
So far we have focused on understanding the disease in a single location and the limitations of using case-count data to understand population quantities of interest.  Many in the
