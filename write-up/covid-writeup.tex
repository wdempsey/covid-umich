...
Specific weight calculations and adjustments are deferred to Section~\ref{section:applications}. Here, we briefly discuss a non-parametric kernel approach.  We start by using considering a pseudo-likelihood
\begin{equation}
\label{eq:tvpropensity}
...
\begin{rmk}[Cumulative demographics]
...
\multirow{2}{*}{Sex} & Female & 58\% & 55\% & 51\% & 21.7\% & 1.42\% \\
& Male & 42 & 45 & 49 & 24.2 & 2.13 \\ \hline
\multirow{3}{*}{Age} & $<40$ & 40 & 28 & 53 & 29.7 & 1.71 \\
& $40-59$ & 41 & 36 & 25 & 24.9 & 2.09 \\
& $\geq 60$ & 19 & 36 & 22 & 6.7 & 0.92 \\ \hline
\multirow{2}{*}{Race} & White & 23 & 92 & 87 \\
& Nonwhite & 77 & 8 & 13 \\ \hline
\multirow{2}{*}{Symptom} & Yes & 62 & 43 & - &  \\
& No & 38 & 57 & - & \\ \hline
\multirow{2}{*}{Contact} & Yes & 11 & 1 & - \\
& No & 89 & 99 & - \\ \hline
\multirow{2}{*}{Prior test} & Yes & 6 & 1 & - \\
& No & 94 & 99 & - \\ \hline
\end{tabular}
\caption{Temp}
\end{table}

Average between May 2nd and 3rd is 11.7\% statewide.  So we need to adjust all these estimates down and then re-weight.



% Random sample
% Symptom 0, Test 0 2040
% Symptom 0, Test 1 18
% Symptom 1, Test 0 1518
% Symptom 1, Test 1 29
% Total symptom 1; (1518+29)/3605 = 43
% Pos test symptom 1; (29)/(29+18) = 62

% Avg 100 COVID-19 hospitalizations in state in that time
% 650 cases
% percent of cases in nonrandom sample with symptoms = 184/(184+37) = 83%
% Then 83% * 650 = 540 symptomatic cases
% 100/540 = 19% of symptomatic cases were hospitalized

% Example: prior to April 28th, only symptoms and a few others
% 04/11: around 500 cases
% 04/11: 117 hospitalizations -> 615 cases
