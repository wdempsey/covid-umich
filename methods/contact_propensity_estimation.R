...
fb_data_neg_contact = readRDS("../data/fb_weeklycomplete_neg_contact.RDS")
...
## Brining in complete FB and Indiana data
fb_data_pos_contact = readRDS("../data/fb_weeklycomplete_pos_contact.RDS")
...
saveRDS(results, "../data/smoothedpropensities_pos_contact.RDS")
